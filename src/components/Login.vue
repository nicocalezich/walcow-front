  ...
  <section class="src-components-login">
    <div class="container">
      <vue-form :state="formState" @submit.prevent="enviar()">
        ...
        <!-- password -->
        <validate tag="div">
          <label for="password">Password <svg v-if="isHidden" @click="showPassword()" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">
          ...
          <svg v-else @click="hidePassword()" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
